...
const DICT: Dict = {
 ...
 "home.tabs.badges": { en: "Badges", ja: "バッジ" },
  ...
  "auth.forgot": { en: "Forgot password?", ja: "パスワードをお忘れですか？" },
  "auth.resetTitle": { en: "Reset your password", ja: "パスワードをリセット" },
  "auth.resetHint": { en: "Enter your email and we'll send you a reset link.", ja: "メールアドレスを入力すると、リセット用のリンクをお送りします。" },
  "auth.sendReset": { en: "Send reset link", ja: "リセットリンクを送信" },
  "auth.resetSent": { en: "Check your email for the reset link.", ja: "リセットリンクをメールでご確認ください。" },
  "auth.newPassword": { en: "New password", ja: "新しいパスワード" },
  "auth.updatePassword": { en: "Update password", ja: "パスワードを更新" },
  "auth.passwordUpdated": { en: "Password updated. You're signed in.", ja: "パスワードを更新しました。" },
  "auth.backToSignin": { en: "Back to sign in", ja: "ログインに戻る" },
